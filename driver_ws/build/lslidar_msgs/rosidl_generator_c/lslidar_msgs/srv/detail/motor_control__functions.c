...
lslidar_msgs__srv__MotorControl_Request__are_equal(const lslidar_msgs__srv__MotorControl_Request * lhs, const lslidar_msgs__srv__MotorControl_Request * rhs)
{
  ...
  // motor_control
  if (lhs->motor_control != rhs->motor_control) {
    return false;
  }
  return true;
}
  ...
  lslidar_msgs__srv__MotorControl_Request * output)
{
  ...
  // motor_control
  output->motor_control = input->motor_control;
  return true;
}
...
lslidar_msgs__srv__MotorControl_Request__create()
{
  ...
  lslidar_msgs__srv__MotorControl_Request * msg = (lslidar_msgs__srv__MotorControl_Request *)allocator.allocate(sizeof(lslidar_msgs__srv__MotorControl_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(lslidar_msgs__srv__MotorControl_Request));
  bool success = lslidar_msgs__srv__MotorControl_Request__init(msg);
  if (!success) {
...
lslidar_msgs__srv__MotorControl_Request__destroy(lslidar_msgs__srv__MotorControl_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    lslidar_msgs__srv__MotorControl_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
lslidar_msgs__srv__MotorControl_Request__Sequence__init(lslidar_msgs__srv__MotorControl_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lslidar_msgs__srv__MotorControl_Request * data = NULL;

  if (size) {
    data = (lslidar_msgs__srv__MotorControl_Request *)allocator.zero_allocate(size, sizeof(lslidar_msgs__srv__MotorControl_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = lslidar_msgs__srv__MotorControl_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        lslidar_msgs__srv__MotorControl_Request__fini(&data[i - 1]);
      }
...
lslidar_msgs__srv__MotorControl_Request__Sequence__fini(lslidar_msgs__srv__MotorControl_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      lslidar_msgs__srv__MotorControl_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lslidar_msgs__srv__MotorControl_Request__Sequence * array = (lslidar_msgs__srv__MotorControl_Request__Sequence *)allocator.allocate(sizeof(lslidar_msgs__srv__MotorControl_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = lslidar_msgs__srv__MotorControl_Request__Sequence__init(array, size);
  if (!success) {
...
lslidar_msgs__srv__MotorControl_Request__Sequence__destroy(lslidar_msgs__srv__MotorControl_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    lslidar_msgs__srv__MotorControl_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
lslidar_msgs__srv__MotorControl_Request__Sequence__are_equal(const lslidar_msgs__srv__MotorControl_Request__Sequence * lhs, const lslidar_msgs__srv__MotorControl_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lslidar_msgs__srv__MotorControl_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  lslidar_msgs__srv__MotorControl_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lslidar_msgs__srv__MotorControl_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lslidar_msgs__srv__MotorControl_Request * data =
      (lslidar_msgs__srv__MotorControl_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lslidar_msgs__srv__MotorControl_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lslidar_msgs__srv__MotorControl_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!lslidar_msgs__srv__MotorControl_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lslidar_msgs__srv__MotorControl_Response * msg = (lslidar_msgs__srv__MotorControl_Response *)allocator.allocate(sizeof(lslidar_msgs__srv__MotorControl_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(lslidar_msgs__srv__MotorControl_Response));
  bool success = lslidar_msgs__srv__MotorControl_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
lslidar_msgs__srv__MotorControl_Response__destroy(lslidar_msgs__srv__MotorControl_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    lslidar_msgs__srv__MotorControl_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
lslidar_msgs__srv__MotorControl_Response__Sequence__init(lslidar_msgs__srv__MotorControl_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lslidar_msgs__srv__MotorControl_Response * data = NULL;

  if (size) {
    data = (lslidar_msgs__srv__MotorControl_Response *)allocator.zero_allocate(size, sizeof(lslidar_msgs__srv__MotorControl_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = lslidar_msgs__srv__MotorControl_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        lslidar_msgs__srv__MotorControl_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
lslidar_msgs__srv__MotorControl_Response__Sequence__fini(lslidar_msgs__srv__MotorControl_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      lslidar_msgs__srv__MotorControl_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lslidar_msgs__srv__MotorControl_Response__Sequence * array = (lslidar_msgs__srv__MotorControl_Response__Sequence *)allocator.allocate(sizeof(lslidar_msgs__srv__MotorControl_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = lslidar_msgs__srv__MotorControl_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
lslidar_msgs__srv__MotorControl_Response__Sequence__destroy(lslidar_msgs__srv__MotorControl_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    lslidar_msgs__srv__MotorControl_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
lslidar_msgs__srv__MotorControl_Response__Sequence__are_equal(const lslidar_msgs__srv__MotorControl_Response__Sequence * lhs, const lslidar_msgs__srv__MotorControl_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lslidar_msgs__srv__MotorControl_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  lslidar_msgs__srv__MotorControl_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lslidar_msgs__srv__MotorControl_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lslidar_msgs__srv__MotorControl_Response * data =
      (lslidar_msgs__srv__MotorControl_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lslidar_msgs__srv__MotorControl_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lslidar_msgs__srv__MotorControl_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!lslidar_msgs__srv__MotorControl_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
