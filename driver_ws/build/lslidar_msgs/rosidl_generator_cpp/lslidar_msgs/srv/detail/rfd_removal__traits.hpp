  ...
  std::ostream & out)
{
  ...
  {
    out << "rfd_removal: ";
    rosidl_generator_traits::value_to_yaml(msg.rfd_removal, out);
  }
  out << "}";
...
inline std::string to_yaml(const RfdRemoval_Request & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const lslidar_msgs::srv::RfdRemoval_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const lslidar_msgs::srv::RfdRemoval_Request & msg)
{
...
inline std::string to_yaml(const RfdRemoval_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use lslidar_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const lslidar_msgs::srv::RfdRemoval_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  lslidar_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use lslidar_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const lslidar_msgs::srv::RfdRemoval_Response & msg)
{
  return lslidar_msgs::srv::to_yaml(msg);
}
