...
inline void to_flow_style_yaml(
  const AngleDistortionCorrection_Request & msg,
  std::ostream & out)
{
  out << "{";
  // member: angle_distortion_correction
  {
    out << "angle_distortion_correction: ";
    rosidl_generator_traits::value_to_yaml(msg.angle_distortion_correction, out);
  }
  out << "}";
...
inline std::string to_yaml(const AngleDistortionCorrection_Request & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const lslidar_msgs::srv::AngleDistortionCorrection_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const lslidar_msgs::srv::AngleDistortionCorrection_Request & msg)
{
...
inline void to_flow_style_yaml(
  const AngleDistortionCorrection_Response & msg,
  std::ostream & out)
{
  out << "{";
  // member: result
...
inline std::string to_yaml(const AngleDistortionCorrection_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use lslidar_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const lslidar_msgs::srv::AngleDistortionCorrection_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  lslidar_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use lslidar_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const lslidar_msgs::srv::AngleDistortionCorrection_Response & msg)
{
  return lslidar_msgs::srv::to_yaml(msg);
}
