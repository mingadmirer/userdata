...
{
  const auto & member =
    *reinterpret_cast<const std::array<uint8_t, 1212> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::array<uint8_t, 1212> *>(untyped_member);
  return &member[index];
}

void fetch_function__LslidarPacket__data(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const uint8_t *>(
    get_const_function__LslidarPacket__data(untyped_member, index));
  auto & value = *reinterpret_cast<uint8_t *>(untyped_value);
  value = item;
}

void assign_function__LslidarPacket__data(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<uint8_t *>(
    get_function__LslidarPacket__data(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LslidarPacket_message_member_array[2] = {
  ...
  },
  {
    ...
    fetch_function__LslidarPacket__data,  // fetch(index, &value) function pointer
    assign_function__LslidarPacket__data,  // assign(index, value) function pointer
    nullptr  // resize(index) function pointer
  }
};
