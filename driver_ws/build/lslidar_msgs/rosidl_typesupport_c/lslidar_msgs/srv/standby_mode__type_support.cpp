...
static const _StandbyMode_Request_type_support_symbol_names_t _StandbyMode_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lslidar_msgs, srv, StandbyMode_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lslidar_msgs, srv, StandbyMode_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lslidar_msgs, srv, StandbyMode_Request)() {
  return &::lslidar_msgs::srv::rosidl_typesupport_c::StandbyMode_Request_message_type_support_handle;
}
...
static const _StandbyMode_Response_type_support_symbol_names_t _StandbyMode_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lslidar_msgs, srv, StandbyMode_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lslidar_msgs, srv, StandbyMode_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, lslidar_msgs, srv, StandbyMode_Response)() {
  return &::lslidar_msgs::srv::rosidl_typesupport_c::StandbyMode_Response_message_type_support_handle;
}
...
static const _StandbyMode_type_support_symbol_names_t _StandbyMode_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, lslidar_msgs, srv, StandbyMode)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, lslidar_msgs, srv, StandbyMode)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, lslidar_msgs, srv, StandbyMode)() {
  return &::lslidar_msgs::srv::rosidl_typesupport_c::StandbyMode_service_type_support_handle;
}
