...
#include "detection_interfaces/msg/detail/detection_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const detection_interfaces::msg::DetectionResult &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  detection_interfaces::msg::DetectionResult &);
size_t get_serialized_size(
  const detection_interfaces::msg::DetectionResult &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const detection_interfaces::msg::DetectionArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  detection_interfaces::msg::DetectionArray & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: detections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        detection_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_DetectionResult(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = detection_interfaces::msg::DetectionArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const detection_interfaces::msg::DetectionArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<detection_interfaces::msg::DetectionArray *>(
    untyped_ros_message);
...
static size_t _DetectionArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DetectionArray(full_bounded, is_plain, 0);
...
{
  return &detection_interfaces::msg::typesupport_fastrtps_cpp::_DetectionArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, detection_interfaces, msg, DetectionArray)() {
  return &detection_interfaces::msg::typesupport_fastrtps_cpp::_DetectionArray__handle;
}
