    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'detection_interfaces.msg.DetectionArray')
            logger.debug(
            ...
            if DetectionResult.__class__._TYPE_SUPPORT is None:
                DetectionResult.__class__.__import_type_support__()
...
class DetectionArray(metaclass=Metaclass_DetectionArray):
    ...
    _fields_and_field_types = {
        ...
        'detections': 'sequence<detection_interfaces/DetectionResult>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['detection_interfaces', 'msg'], 'DetectionResult')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, DetectionResult) for v in value) and
                 True), \
                "The 'detections' field must be a set or sequence and each value of type 'DetectionResult'"
