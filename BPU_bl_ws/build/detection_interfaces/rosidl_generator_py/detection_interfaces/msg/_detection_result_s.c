...
bool detection_interfaces__msg__detection_result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("detection_interfaces.msg._detection_result.DetectionResult", full_classname_dest, 58) == 0);
  }
  detection_interfaces__msg__DetectionResult * ros_message = _ros_message;
  {  // name
...
PyObject * detection_interfaces__msg__detection_result__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("detection_interfaces.msg._detection_result");
