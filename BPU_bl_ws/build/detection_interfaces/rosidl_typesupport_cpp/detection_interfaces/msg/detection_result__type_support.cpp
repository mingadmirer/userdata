...
static const _DetectionResult_type_support_symbol_names_t _DetectionResult_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, detection_interfaces, msg, DetectionResult)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, detection_interfaces, msg, DetectionResult)),
  }
};
...
{
  return &::detection_interfaces::msg::rosidl_typesupport_cpp::DetectionResult_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, detection_interfaces, msg, DetectionResult)() {
  return get_message_type_support_handle<detection_interfaces::msg::DetectionResult>();
}
