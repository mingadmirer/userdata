...
static const _DetectionArray_type_support_symbol_names_t _DetectionArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, detection_interfaces, msg, DetectionArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, detection_interfaces, msg, DetectionArray)),
  }
};
...
{
  return &::detection_interfaces::msg::rosidl_typesupport_cpp::DetectionArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, detection_interfaces, msg, DetectionArray)() {
  return get_message_type_support_handle<detection_interfaces::msg::DetectionArray>();
}
