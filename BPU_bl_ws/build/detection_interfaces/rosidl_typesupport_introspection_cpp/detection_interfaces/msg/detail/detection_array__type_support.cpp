...
{
  new (message_memory) detection_interfaces::msg::DetectionArray(_init);
}

void DetectionArray_fini_function(void * message_memory)
{
  auto typed_message = static_cast<detection_interfaces::msg::DetectionArray *>(message_memory);
  typed_message->~DetectionArray();
}

size_t size_function__DetectionArray__detections(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<detection_interfaces::msg::DetectionResult> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<detection_interfaces::msg::DetectionResult> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<detection_interfaces::msg::DetectionResult> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const detection_interfaces::msg::DetectionResult *>(
    get_const_function__DetectionArray__detections(untyped_member, index));
  auto & value = *reinterpret_cast<detection_interfaces::msg::DetectionResult *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<detection_interfaces::msg::DetectionResult *>(
    get_function__DetectionArray__detections(untyped_member, index));
  const auto & value = *reinterpret_cast<const detection_interfaces::msg::DetectionResult *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DetectionArray_message_member_array[2] = {
  {
    ...
    offsetof(detection_interfaces::msg::DetectionArray, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<detection_interfaces::msg::DetectionResult>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(detection_interfaces::msg::DetectionArray, detections),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DetectionArray_message_members = {
  ...
  2,  // number of fields
  sizeof(detection_interfaces::msg::DetectionArray),
...
get_message_type_support_handle<detection_interfaces::msg::DetectionArray>()
{
  return &::detection_interfaces::msg::rosidl_typesupport_introspection_cpp::DetectionArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, detection_interfaces, msg, DetectionArray)() {
  return &::detection_interfaces::msg::rosidl_typesupport_introspection_cpp::DetectionArray_message_type_support_handle;
}
