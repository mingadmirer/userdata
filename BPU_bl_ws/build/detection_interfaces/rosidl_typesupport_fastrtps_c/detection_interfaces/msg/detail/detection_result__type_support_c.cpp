...
#include "detection_interfaces/msg/detail/detection_result__rosidl_typesupport_fastrtps_c.h"
...
using _DetectionResult__ros_msg_type = detection_interfaces__msg__DetectionResult;
...
static uint32_t _DetectionResult__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_detection_interfaces__msg__DetectionResult(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = detection_interfaces__msg__DetectionResult;
    is_plain =
      (
...
static size_t _DetectionResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_detection_interfaces__msg__DetectionResult(
