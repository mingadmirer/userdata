...
: ${AMENT_CURRENT_PREFIX:="/userdata/BPU_bl_ws/install/utils"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/utils/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/utils/environment/path.sh"
