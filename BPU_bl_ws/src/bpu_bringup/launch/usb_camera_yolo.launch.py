...
def generate_launch_description():
    ...
    bpu_bringup_config_path = os.path.join(get_package_share_directory('bpu_bringup'), "config")
    os.system(f"cp -r {bpu_bringup_config_path}/coco_80 ./config/")
    os.system(f"cp -r {bpu_bringup_config_path}/custom_4 ./config/")
